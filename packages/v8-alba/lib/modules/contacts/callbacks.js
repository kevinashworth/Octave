...
*/
function ContactEditUpdateProjects (data, { document }) {
...
*/
function ContactEditUpdatePastProjects (data, { document }) {
  const contact = document
...
addCallback('contact.create.after', ContactEditUpdatePastProjects)

addCallback('contact.update.after', ContactEditUpdateOffices)
addCallback('contact.update.after', ContactEditUpdateProjects)
addCallback('contact.update.after', ContactEditUpdatePastProjects)

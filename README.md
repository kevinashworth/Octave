...
4. Run the commands `npm run prepare` then `npm install --production`.<sup>1</sup> (If you want to do development or download the large e2e testing packages, simply run `npm install` instead.)

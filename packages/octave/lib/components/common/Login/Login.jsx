...
const Login = (props) => {
  ...
  const [formHeadings, setFormHeadings] = useState({
    ...
    formSubheading: 'Access your Octave account'
  })
  ...
  const handleFormStateChange = (state) => {
    ...
    switch (state) {
      ...
      case Symbol.for('SIGN_UP'):
        setFormHeadings({
          formHeading: 'Sign Up',
          formSubheading: 'Sign up for a Octave account'
        })
        break
  ...
  return (
    <div className='animated fadeIn'>
      <Components.MyHeadTags title='Login/Logout' />
          ...
          <Card className='p-4'>
            <Card.Body>
              ...
              <MyAccountsLoginForm
                ...
                onSignedInHook={() => window.location.assign('/')}
              />
            </Card.Body>
          </Card>
        </Col>

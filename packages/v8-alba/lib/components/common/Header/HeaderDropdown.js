...
class HeaderDropdown extends PureComponent {
  ...
  dropTasks () {
    ...
    return (
      <Dropdown nav className='d-md-down-none' isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        <DropdownToggle nav>
          <i className='icon-list' /><Badge pill color='warning'>{itemsCount}</Badge>
        </DropdownToggle>
  ...
  dropMssgs () {
    ...
    return (
      <Dropdown nav className='d-md-down-none' isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        <DropdownToggle nav>
          <i className='icon-envelope-letter' /><Badge pill color='info'>{itemsCount}</Badge>
        </DropdownToggle>
        <DropdownMenu right className='dropdown-menu-lg'>
          ...
          <DropdownItem href='#'>
            <div className='message'>
              ...
              <div className='text-truncate font-weight-bold'><span className='fa fa-exclamation text-danger' /> Important message</div>

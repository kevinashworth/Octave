...
const UserCommentsList = ({className, results, loading, count, totalCount, loadMore, showHeader = true, showLoadMore = true, networkStatus, currentUser, error, terms}) => {
...
const options = {
  ...
  fragmentName: 'UserCommentsList',
};

registerComponent({ name: 'UserCommentsList', component: UserCommentsList, hocs: [withCurrentUser, [withMulti, options]] });
